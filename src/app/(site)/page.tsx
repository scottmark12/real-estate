    ...
    <div className="mx-auto max-w-[1500px] px-12">
      ...
      <section className="pt-10">
        <div className="relative flex flex-col gap-10 lg:grid lg:grid-cols-[minmax(0,45fr)_minmax(0,55fr)] lg:gap-x-0 lg:gap-y-0">
          <div className="lg:col-start-1 lg:row-start-1 lg:self-start lg:pl-32">
          ...
          <div className="relative lg:col-start-2 lg:row-start-1 lg:row-span-2 lg:-ml-28 lg:self-end lg:-mb-16">
            <Image
